...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .card { border: 1px solid color-mix(in srgb, var(--text) 12%, transparent); border-radius: 14px; padding: 26px; background: var(--bg); box-shadow: 0 1px 3px color-mix(in srgb, var(--text) 6%, transparent); transition: transform 0.15s ease, box-shadow 0.15s ease; }
  .card:hover { transform: translateY(-2px); box-shadow: 0 8px 20px color-mix(in srgb, var(--text) 10%, transparent); }
